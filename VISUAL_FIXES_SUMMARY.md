...
- Duplicate `general_style` divs in migrated pages (BaseLayout already includes it)
...
**Note**: This needs careful testing as sed might remove too much. Better approach:
1. Open each page
