...
```bash
bunx claude-flow hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
bunx claude-flow hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
bunx claude-flow hook pre-edit --file "path/to/file.js" --validate-syntax
```
