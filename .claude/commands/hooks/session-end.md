...
```bash
bunx claude-flow hook session-end -s "quick-fix" --save-state false --cleanup-temp
```

### Complete persistence

```bash
bunx claude-flow hook session-end -s "major-refactor" --save-state --export-metrics --generate-summary
```
...
```bash
# At session end
bunx claude-flow hook session-end --session-id "your-session" --generate-summary
```
